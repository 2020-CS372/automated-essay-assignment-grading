...
def quality_data():
    with open(f'{settings.QUALITY_DATA_DIR}/quality_data.csv') as csvfile:
...
def duplicates_print():
    data = duplicates()
    for d in data:
        print(f"id:{d['essay_id']} - word_duplicates_num: {d['word_duplicates_num']} - bigram_duplicates_num: {d['bigram_duplicates_num']} - score: {d['score']}")
